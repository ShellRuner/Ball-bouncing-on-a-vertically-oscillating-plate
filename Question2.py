...
"""Creation d'une plage de 500 valeurs de omega
comprises entre 2pi et 20pi c-a-d pour des frequences comprises
entre 1Hz et 10Hz
"""
valeurs_omega = np.linspace(2*np.pi, 20*np.pi, 500)
...
donnee_De_bifurcation = Tc.Bifurcation_Diagrame(simulation, valeurs_omega)
donnee_De_bifurcation_tab = np.array(donnee_De_bifurcation)
plt.figure(figsize=(12, 6))
Tc.TracerBifurc(donnee_De_bifurcation_tab)
plt.show()
